...
export const zh_country_names = {
    ...
    "Macedonia, the Former Yugoslav Republic of": "北马其顿",
    "Mali": "马里",
    "Myanmar": "缅甸",
    "Mongolia": "蒙古",
    "Macao": "中国澳门",
...
export function getCountryNameZh(code) {
    if (!code) return "";
    // 从inverted中查找英文名,再转中文
    const { inverted_countries_abreviations } = require("./countries.js");
    const enName = inverted_countries_abreviations[code];
    if (!enName) return code;
    return zh_country_names[enName] || enName;
}
